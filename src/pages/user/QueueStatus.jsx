...
export default function QueueStatus() {
    const { currentUser, services, getUserActiveQueues, getEstimatedWait, leaveQueue } = useApp();
            ...
            <div className="animate-fade-in-up">
                ...
                <div className="text-center py-16 bg-white rounded-2xl border border-stone-200">
                    ...
                    <p className="text-stone-500 mb-6 max-w-sm mx-auto text-sm">
                        Join a tutoring service queue and you'll see your live position and estimated wait time here.
                    </p>
                    <Link to="/join-queue"
                        className="inline-flex items-center gap-2 px-6 py-2.5 rounded-xl text-white text-sm font-semibold no-underline transition-all hover:opacity-90"
        ...
        <div className="animate-fade-in-up">
            ...
            <div className="space-y-6 stagger-children">
                {activeQueues.map((q) => {
                    ...
                    return (
                        <div key={q.id} className="bg-white rounded-2xl border border-stone-200 overflow-hidden animate-fade-in-up">
                            {/* Header strip */}
                            ...
                            <div className="p-6">
                                ...
                                <div className="flex items-start justify-between mb-6">
                                    ...
                                    <div className="flex items-center gap-2 px-3 py-1.5 rounded-xl"
                                        style={{
                                            ...
                                            border: `1px solid ${isNext ? '#bfdbfe' : isAlmostReady ? '#fde68a' : '#bbf7d0'}`,
                                        }}>
                                ...
                                <div className="grid grid-cols-3 gap-4 mb-6">
                                    <div className="text-center p-4 rounded-xl bg-stone-50">
                                        <p className="text-xs text-stone-500 mb-1 uppercase tracking-wide font-medium">Position</p>
                                        <p className="text-4xl font-bold" style={{ color: isNext ? '#2563eb' : '#C8102E' }}>
                                            #{q.position}
                                        </p>
                                    </div>
                                    <div className="text-center p-4 rounded-xl bg-stone-50">
                                        <p className="text-xs text-stone-500 mb-1 uppercase tracking-wide font-medium">Est. Wait</p>
                                    ...
                                    <div className="text-center p-4 rounded-xl bg-stone-50">
                                        <p className="text-xs text-stone-500 mb-1 uppercase tracking-wide font-medium">Joined</p>
                                ...
                                <div className="mb-6">
                                    <div className="flex items-center justify-between mb-2">
                                        ...
                                        <span className="text-xs font-semibold" style={{ color: isNext ? '#2563eb' : '#C8102E' }}>
                                ...
                                <div className="flex items-center justify-between px-2 mb-6">
                                    {['Joined', 'Waiting', 'Almost Ready', 'Your Turn'].map((step, i) => {
                                        const isComplete = i === 0 || (i === 1 && q.position <= 3) || (i === 2 && q.position <= 2) || (i === 3 && q.position === 1);
                                        return (
                                            <div key={step} className="flex flex-col items-center gap-1.5">
                                                ...
                                                <span className={`text-xs font-medium ${isComplete ? 'text-red-700' : 'text-stone-400'}`}>
                                                    {step}
                                                </span>
                                            </div>
                                        );
